...
good_gene <- paste(readLines("../MIP/txt/cov/good_gene_above_90_v2.cov"),collapse="|")
...
############### Now call the CNVs
    ...
    saveRDS(result,glue('raw/{pd_number[n]}_result_test_v20.rds'))
}
...
################ Now call the CNVs
    ...
    saveRDS(result,glue('raw/{ctrl_number[n]}_result_test_v20.rds'))
}
