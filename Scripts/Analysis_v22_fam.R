...
badProbes <- readLines("../MIP/txt/cov/bad_probe_less_than_100.cov")
...
############### Now call the CNVs
    ...
    saveRDS(result,glue('raw/{pd_number[n]}_result_test_v22.rds'))
}
...
################ Now call the CNVs
    ...
    saveRDS(result,glue('raw/{ctrl_number[n]}_result_test_v22.rds'))
}
